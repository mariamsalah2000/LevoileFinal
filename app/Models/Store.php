...
class Store extends Model {
    ...
    public function getSales() {
        return $this->hasMany(Sale::class, 'store_id', 'table_id');
    }
    public function getPendings() {
        return $this->hasMany(PendingOrder::class, 'store_id', 'table_id');
    }
    public function getPrepares() {
        return $this->hasMany(Prepare::class, 'store_id', 'table_id');
    }
    ...
    public function getVariants() {
        return $this->hasMany(ProductVariant::class, 'store_id');
    }
