...
class Order extends Model {
    ...
    {
        return $this->hasOne(Prepare::class,'id');
    }

    public function products()
    {
        return $this->hasMany(PrepareProductList::class, 'order_id');
    }

    public function refund()
    {
        return $this->hasMany(Refund::class,'order_name');
    }
    public function returns()
    {
        return $this->hasMany(ReturnedOrder::class, 'order_number', 'order_number');
    }
