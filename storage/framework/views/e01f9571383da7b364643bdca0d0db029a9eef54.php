        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    ...
                    <td><img id="product_image_info" src="" alt="Product Image" style="width: 100px; height: auto;"></td>
        ...
        <div class="mb-3">
            <div class="row">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="#" id="add-collection-link" data-bs-toggle="modal" data-bs-target="#addCollectionModal" class="d-flex align-items-center">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    console.log(response.variants[0]);
                        ...
                        $('#product_quantity_info').text(response.variants[0].inventory_quantity || 'N/A');

                        const productImage = response.images.length > 0 ? response.images[0].src : 'default_image_url.jpg';
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            loadCollections(); // Reload the collection list with the new collection
                        }
                    }
                });
            } else {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1216098.cloudwaysapps.com/ycnnbqfzvc/public_html/resources/views/ads/create.blade.php ENDPATH**/ ?>