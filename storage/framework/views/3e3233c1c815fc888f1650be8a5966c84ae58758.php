        ...
        <div class="container-fluid">
            <div class="row gutters-5">
                                ...
                                <div class="navbar-holder d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="navbar-header">
                                        ...
                                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                                            ...
                                            <li class="nav-item">
                                                <a href="<?php echo e(route('sales.all')); ?>" id="today-sale-btn" title="Sales"><i
                ...
                <div class="col-md-4 w-md-350px w-lg-400px w-xl-500px">
                    <div class="card mb-3">
                        <div class="card-body">
                            <?php echo Form::open(['route' => 'orders.store', 'method' => 'post', 'files' => true, 'class' => 'payment-form']); ?>
                                        ...
                                        <div class="form-group d-flex border-bottom pb-3">
                                            <?php if(session()->has('customer')): ?>
                                                ...
                                                <input type="number" name="get_customer_sale" id="get_customer_sale"
                                                    ...
                                                    value="<?php echo e($getCustomer->phone_number); ?>" autofocus required
                            ...
                            <div class="" id="cart-details">
                                ...
                                <div>
                                    ...
                                    <div class="d-flex justify-content-between fw-600 fs-18 border-top pt-2">
                                        ...
                                        <span
                                            id="grand-total"><?php echo e($subtotal + $tax + Session::get('pos.shipping', 0) - Session::get('pos.discount', 0)); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="my-2 my-md-0">
                            <button type="button" type="button" class="btn btn-primary btn-block payment-btn"
                                id="cash-btn"><?php echo e(trans('Place Order')); ?>
...
<?php echo $__env->make('layouts.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1216098.cloudwaysapps.com/ycnnbqfzvc/public_html/resources/views/pos/index.blade.php ENDPATH**/ ?>