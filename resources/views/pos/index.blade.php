    ...
    @if (session()->has('phone_number'))
        <div class="alert alert-danger alert-dismissible text-center">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                    aria-hidden="true">&times;</span></button>{{ session()->first('phone_number') }}
        </div>
    @endif
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                                        ...
                                        <div class="form-group d-flex border-bottom pb-3">
                                            @if (session()->has('customer'))
                                                ...
                                                <input type="number" name="get_customer_sale" id="get_customer_sale"
                                                    ...
                                                    value="{{ $getCustomer->phone_number }}" autofocus required
                                                    minlength="11" maxlength="15" autocomplete="off">
                                            @else
                                                <input type="number" name="get_customer_sale" id="get_customer_sale"
                                                    placeholder="Search for Customer by Phone" class="form-control"
                                                    autofocus required autocomplete="off" minlength="11" maxlength="15">
                                            @endif
                            ...
                            <div class="" id="cart-details">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <textarea name="shipping_note" class="form-control" placeholder="Add Shipping Note"></textarea>
                                    </div>
                                    <div class="col-6">
                                        <textarea name="prepare_note" class="form-control" placeholder="Add Preparation Note"></textarea>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="d-flex justify-content-between fw-600 fs-18 border-top pt-2">
                                        ...
                                        <span
                                            id="grand-total">{{ $subtotal + $tax + Session::get('pos.shipping', 0) - Session::get('pos.discount', 0) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="province" id="province2" required class="form-control">
                                        <option value="">Choose Governorate</option>
                                        @foreach (\App\Models\ShippingFee::get() as $key => $shipping)
                                            <option value="{{ $shipping->city }}">{{ $shipping->city }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).on('change', '#mark_as_paid', function() {
            ...
            if (this.checked) {
                ...
                options += '<br>'
                options +=
                    "<input type='file'  class='form-control' name='trx_img'>"
