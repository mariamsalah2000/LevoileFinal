                ...
                <div class="col-md-auto w-md-350px w-lg-400px w-xl-500px">
                        ...
                        <div class="card-body">
                                ...
                                <div class="flex-grow-1">
                                    <div class="form-group">
                                        @if (session()->has('customer'))
                                            @php
                                                $getCustomer = \App\Customer::find(session()->get('customer'));
                                            @endphp
                                            <input type="number" name="get_customer_sale" id="get_customer_sale"
                                                placeholder="Search for Customer by Phone" class="form-control"
                                                value="{{ $getCustomer->phone_number }}" autofocus required minlength="11"
                                                maxlength="15" autocomplete="off">
                                        @else
                                            <input type="number" name="get_customer_sale" id="get_customer_sale"
                                                placeholder="Search for Customer by Phone" class="form-control" autofocus
                                                required autocomplete="off" @endif minlength="11"
                                            maxlength="15">

                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group" id="address-section"></div>
                                        <div class="form-group" id="customer-section"></div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <select class="form-control" name="source" required>
                                                <option value="">Choose Order Source ...</option>
                            ...
                            <div class="" id="cart-details">
                                ...
                                <div>
                                    ...
                                    <div class="d-flex justify-content-between fw-600 mb-2 opacity-70 d-lg-none">
                    ...
                    <div class="pos-footer mar-btm">
                        <div class="d-flex flex-column flex-md-row justify-content-between">
                            <div class="d-flex">
                                <div class="dropdown mr-3 ml-0 dropup d-none">
            ...
            <div class="modal-content" id="variants">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btn-styled btn-base-1"
                        onclick="save_chosen_address()">{{ translate('Save') }}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="new-customer" class="modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom" role="document">
            <div class="modal-content">
                <div class="modal-header bord-btm">
                    <h4 class="modal-title h6">{{ translate('Add New Customer') }}</h4>
                    <button type="button" class="close" data-dismiss="modal"><span
                            aria-hidden="true">&times;</span></button>
                </div>
                <form id="shipping_form">
                    <div class="modal-body" id="shipping_addresss">
                        <div class="form-group">
                            <div class="row">
                            ...
                            <div class=" row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" min="0" placeholder="{{ translate('Phone') }}"
                                        id="customer_phone" name="phone" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class=" row">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" placeholder="{{ translate('Email') }}" id="email"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btn-styled btn-base-1"
                        id="confirm-address">{{ translate('Confirm') }}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="new-address-modal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal" id="new_address_form">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class=" row">
                                <label class="col-sm-2 control-label">{{ translate('Country') }}</label>
                                <div class="col-sm-10">
                                    <select id="country_select" class="form-control aiz-selectpicker"
                                        data-live-search="true" data-placeholder="{{ translate('Select your country') }}"
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <select id="state_select" class="form-control mb-3 aiz-selectpicker"
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <select id="city_select" class="form-control mb-3 aiz-selectpicker"
...
@section('script')
    <script type="text/javascript">
        ...
        $("#confirm-address").click(function() {
            ...
            var form_name = data.get('name');
            var form_phone = data.get('phone');
            var form_email = data.get('email');
            var form_address = data.get('address');
            var form_country_id = data.get('country_id');
            var form_state_id = data.get('state_id');
            var form_city_id = data.get('city_id');

            if (form_name == '') {
                alert('Please Type Customer Name');
                check = 0;
            } else if (form_phone == '') {
                alert('Please Type Customer Phone');
                check = 0;
            } else if (form_address == '') {
                alert('Please Type Customer Address');
                check = 0;
            } else if (form_country_id == ' ') {
                alert('Please Choose Country');
                check = 0;
            } else if (form_state_id == ' ') {
                alert('Please Choose State');
                check = 0;
            } else if (form_city_id == ' ') {
            ...
            if (check == 1) {
                $.ajax({
                    ...
                    success: function(data, textStatus, jqXHR) {
                        ...
                        shipping = "35";
                        section.html("");
                        options += '<span>Customer Name is :' + data + ' </span>';
                        section.append(options);
                        AIZ.plugins.notify('success', data + " Found , Continue Your Order ");
                    }
                })
        ...
        $("#add_address").click(function() {
            var data = new FormData($('#new_address_form')[0]);
            var check = 0;
            ...
            if (check == 1) {
                $.ajax({
                    ...
                    success: function(data, textStatus, jqXHR) {
                        console.log(data);
                        document.getElementById("new_address_form").reset();
                        $('#new-address-modal').modal('hide');
                        $('#choose-address').modal('hide');
                        sessionStorage.setItem("chosen", data.id);
                        var options = '';
                        var section = $('#address-section');
                        section.html('');
                        options += '<span>Customer Address is : ' + data.address + '</span>';
                        section.append(options);
                        AIZ.plugins.notify('success', " New Address Added!");
                    }
                })
        ...
        function save_chosen_address() {
            var address = $("input:radio[name='address_id']:checked").attr('id');
            sessionStorage.setItem("chosen", address);
            $('#choose-address').modal('hide');
            var options = '';
            var section = $('#address-section');
            section.html('');
            var address = $("input:radio[name='address_id']:checked").attr('id');
            options += '<span>Customer Address is : ' + address + '</span>';
            section.append(options);
        }
        ...
        function getShippingAddress() {
            $('#choose-address').modal('show');
            var chosen = $("input:radio[name='address_id']:checked").attr('id');
            $.post('{{ route('pos.getShippingAddress') }}', {
                _token: AIZ.data.csrf,
                phone: $('input[name=get_customer_sale]').val()
            }, function(data) {
                $('#show-address').html(data);
                console.log(document.getElementById(sessionStorage.getItem('chosen')));
                if (document.getElementById(sessionStorage.getItem('chosen')))
                    document.getElementById(sessionStorage.getItem('chosen')).checked = true;
            });
        ...
        function add_new_address() {
            ...
            //$('#new_address_form')[0].removeAttr('selected');
            $('#new-address-modal').modal('show');
            $("#close-button").click();
        }

        function orderConfirmation() {
            var order_source = $('select[name=source]').val();
            var customer_number = $('input[name=get_customer_sale]').val();
            var address = $("input:radio[name='address_id']:checked").val();

            if (order_source == '') {
                alert('Please Select Order Source First');
        ...
        $('#get_customer_sale').on('focusout', function() {
            ...
            if (id.length < minLength) {
                ...
                $.post('{{ route('pos.customerSale') }}', {
                    ...
                    if (data) {
                        section.html('');
                        options += '<span>Customer Name is : ' + data.name + '</span>';
                        options +=
                            '<br><br><button type="button" class="btn btn-soft-dark ml-4 mr-0" onclick="getShippingAddress()"> Choose Address </button>';

                        section.append(options);
                        AIZ.plugins.notify('success', data.name + " Found Continue Your Order ");
                        ...
                        options +=
                            '<button type="button" class="btn btn-icon btn-soft-dark ml-3 mr-0" data-target="#new-customer" data-toggle="modal"> <i class="las la-plus"></i></button>';
                        section.append(options);
                        customer_phone.val(id);
                        AIZ.plugins.notify('danger', " No Customer Found Please Add New One");
                    }
                });
