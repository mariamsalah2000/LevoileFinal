        ...
        <div class="container-fluid">
            <div class="row gutters-5">
                                ...
                                <div class="navbar-holder d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="navbar-header">
                                        ...
                                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                                            ...
                                            <li class="nav-item">
                                                <a href="{{ route('sales.all') }}" id="today-sale-btn" title="Sales"><i
                    ...
                    <div class="row" style="height: 100px; display:flex">
                        <div class="col-lg-12">
                            <input class="form-control form-control-lg" type="text" name="keyword"
                                placeholder="{{ trans('Search by Product Name/Barcode') }}" onkeyup="filterProducts()">
                    ...
                    <div class="aiz-pos-product-list c-scrollbar-light">
                        ...
                        <div id="load-more" class="text-center">
                            <div class="fs-14 d-inline-block fw-600 btn btn-soft-primary c-pointer"
                                onclick="loadMoreProduct()">{{ trans('Loading..') }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 w-md-350px w-lg-400px w-xl-500px">
                    <div class="card mb-3">
                        <div class="card-body">
                            {!! Form::open(['route' => 'orders.update', 'method' => 'post', 'files' => true, 'class' => 'payment-form']) !!}
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group d-flex border-bottom pb-3">
                                            @if (session()->has('customer'))
                                                @php
                                                    $getCustomer = \App\Models\Customer::where(
                                                        'shopify_id',
                                                ...
                                                <input type="number" name="get_customer_sale" id="get_customer_sale"
                                                    ...
                                                    value="{{ $getCustomer->phone_number }}" autofocus required readonly
                                                    minlength="11" maxlength="15" autocomplete="off">
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group" id="customer-section">
                                            <span>Customer Name is : {{ $getCustomer->name }}</span>
                                            <br>
                                            <span>Customer Address is : {{ $getCustomer->address }} </span>
                                            <input type="hidden" id="customer_id_ajax" name="customer_id_ajax"
                                                value="{{ $getCustomer->id }}">
                                            <button type="button" class="btn btn-warning btn-sm" data-toggle="modal"
                                                data-target="#editCustomer"><i class="fa fa-edit"></i></button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group d-flex border-bottom pb-3">
                                            <select class="form-select" name="source" id="source">
                                                <option value="{{ $order->source_name ?? 'Online' }}" selected>
                                                    {{ ucfirst($order->source_name ?? 'online') }}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group d-flex border-bottom pb-3">
                                            <select class="form-select" name="shipping" id="shipping">
                                                ...
                                                <option value="apply" selected>Apply Shipping</option>
                                                <option value="zero">Zero Shipping</option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="my-2 my-md-0">
                            <button type="button" type="button" class="btn btn-primary btn-block payment-btn"
                                id="cash-btn">{{ trans('Update Order') }}
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div role="document" class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label>{{ trans('Email') }} *</strong> </label>
                                    <input type="text" name="email" required class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>{{ trans('Address') }} *</strong> </label>
                                    <input type="text" name="address" required class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>{{ trans('City') }} *</strong> </label>
                                    <input type="text" name="city" required class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>{{ trans('Governorate') }} *</strong> </label>
                                    <select name="province" id="province" required class="form-control">
                                        <option value="">Choose Governorate</option>
                                        @foreach (\App\Models\ShippingFee::get() as $key => $shipping)
                ...
                <div id="editCustomer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    ...
                    <div role="document" class="modal-dialog">
                        <div class="modal-content">
                            ...
                            @csrf
                            <input type="hidden" name="customer_id_edit" value="{{ $getCustomer->id }}">
                            <div class="modal-header">
                                <h5 id="exampleModalLabel" class="modal-title">{{ trans('Edit Customer') }}</h5>
                                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                        aria-hidden="true"><i class="fa fa-cross"></i></span></button>
                            </div>
                            <div class="modal-body">
                                    ...
                                    <select name="province" id="province2" required class="form-control">
                                        ...
                                        @foreach (\App\Models\ShippingFee::get() as $key => $shipping)
                                            <option value="{{ $shipping->city }}"
                                                @if ($getCustomer->state == $shipping->city) selected @endif>{{ $shipping->city }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number" name="phone_number2" required class="form-control"
                                        ...
                                        value="{{ $getCustomer->phone_number }}">
                                </div>
                                <div class="form-group">
                                    <input type="hidden" name="pos" value="1">
                                    <input type="submit" value="{{ trans('submit') }}" class="btn btn-primary">
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-zoom modal-xl">
                        <div class="modal-content" id="variants">
                            <div class="modal-header bord-btm">
                                <h4 class="modal-title h6">{{ trans('Order Summary') }}</h4>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" onclick="submitOrder('cash_on_delivery')"
                                    class="btn btn-base-1 btn-info">{{ trans('Confirm with COD') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        function loadMoreProduct() {
            if (products != null && products.links.next != null) {
                $('#load-more').find('.btn').html('{{ trans('Loading..') }}');
        ...
        function setProductList(data) {
                        ...
                        <div class="card bg-white c-pointer product-card hov-container col-12">
                            <div class="position-relative">
                                <span class="absolute-top-left mt-1 ml-1 mr-0">
                                    ${data.data[i].qty > 0
                                        ? `<span class="badge badge-inline badge-success fs-13">{{ trans('In stock') }}`
                                        : `<span class="badge badge-inline badge-danger fs-13">{{ trans('Out of stock') }}` }
            ...
            if (data.links.next != null) {
                $('#load-more').find('.btn').html('{{ trans('Load More.') }}');
            } else {
                $('#load-more').find('.btn').html('{{ trans('Nothing more found.') }}');
            }
        }
        ...
        $(".payment-btn").on("click", function(e) {
            ...
            if (confirm(
                    "Are you sure want to Update Order?")) {
                var customer_id = $('#customer_id_ajax').val();
                var source = $('#source').val();
                temp_data = $('#lims_productcodeSearch').val();
                if (!customer_id) {
        ...
        $(document).on('change', '#mark_as_paid', function() {
            var payment_section = $('#payment-section');
            if (this.checked) {

                var options = '<select name="paid_by" class="form-control" required>'
                options += '<option value="">Select Payment Method</option>'
                options += '<option value="Instapay">InstaPay</option>'
                options += '<option value="Paymob">Paymob Link</option>'
                options += '<option value="Vodafone Cash">Vodafone Cash</option>'
                options += '</select>'
                options += '<br>'
                options +=
                    "<input type='text' name='transaction_id' class='form-control' placeholder='Please add Payment Transaction'>"
                options += '<br>'
                options +=
                    "<input type='file' name='trx_img' class='form-control'>"
                payment_section.append(options);
            } else {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.errors != "")
                        ...
                        section.html('');
                        var options = "";
                        options += '<span>Customer Name is : ' + name + '</span>';
                        options += '<br><span>Customer Address is : ' + address +
                            '</span>';
                        options +=
