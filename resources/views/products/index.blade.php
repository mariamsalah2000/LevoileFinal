        ...
        <div class="row">
            ...
            <div class="col-4">
                <table class="table table-borderless">
                    <tbody>
                        <tr>
                            <td><a href="{{ route('shopify.product.create') }}" style="float:right"
                                    class="btn btn-success">Create Product</a></td>
                            <td><a href="{{ route('shopify.products.sync') }}" style="float: right"
                                        ...
                                        @foreach ($products as $key => $product)
                                            <tr>
                                                ...
                                                <td><a href="{{ route('change.product.addToCart') }}?product_id={{ $product['table_id'] }}"
                                                        class="btn btn-primary">{{ $product->getAddToCartStatus()['message'] }}</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
