...
@section('content')
    ...
    @if (session()->has('error'))
        <div class="alert alert-danger alert-dismissible text-center"><button type="button" class="close"
                data-dismiss="alert" aria-label="Close"><span
                    aria-hidden="true">&times;</span></button>{{ session()->get('error') }}</div>
    @endif
                                ...
                                <div class="navbar-holder d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="navbar-header">
                                        ...
                                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                                            ...
                                            <li class="nav-item">
                                                <a href="{{ route('stock_requests.index') }}" id="today-sale-btn"
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="my-2 my-md-0">
                            <button type="button" type="button" class="btn btn-primary btn-block payment-btn"
                                id="cash-btn">{{ trans('Confirm Request') }}
                            </button>
                        </div>
                    </div>
                </div>
