            ...
            <div class="col-4">
                <table class="table table-borderless">
                    <tbody>
                        <tr>
                            <td>
                                <a href="#" onclick="upload()" style="float:right" class="btn btn-success">Add
                                    New</a>
                            </td>
                        </tr>
                    </tbody>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Upload Returns Sheet</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body fulfillment_form">
                <form action="{{ route('returns.upload') }}" class="row g-3" method="POST"
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="note" class="form-control" placeholder="Add Returns Note"></textarea>
                    </div>
                    <div class="col-4 justify-content-center">
